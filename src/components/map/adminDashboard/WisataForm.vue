...
export default {
  ...
  watch: {
    editedData: function(updated) {
      ...
      this.center = latLng;
      this.imagePreviewURL = `${this.$API_BASE_URL.API_BASE_URL}venue/img/${updated.imageURL}`;
    }
  },
  props: {
    isEdit: {
      ...
      try {
        ...
        if (!this.isEdit) {
          ...
          response = await this.$http.post(
            `${this.$API_BASE_URL.API_BASE_URL}venue`,
            formData,
            {
              headers: {
          ...
          response = await this.$http.put(
            `${this.$API_BASE_URL.API_BASE_URL}venue/${this.$route.params.wisataId}`,
            formData,
            {
              headers: {
                "Content-Type": `multipart/form-data;`
